...
set_property IOSTANDARD LVCMOS33 [get_ports spi_ssel_n]

# CMOS
set_property PACKAGE_PIN AL32    [get_ports pg_c2m]
set_property IOSTANDARD LVCMOS33 [get_ports pg_c2m]
#set_property PACKAGE_PIN AC39    [get_ports monitor[1]]
#set_property IOSTANDARD LVCMOS33 [get_ports monitor[1]]
#set_property PACKAGE_PIN AC38    [get_ports monitor[0]]
#set_property IOSTANDARD LVCMOS33 [get_ports monitor[0]]
